...
DEVSHELL_DIRENV_FALLBACK=true \
  use_devshell \
  --file flake-compat.nix \
  devShells."$(nix --extra-experimental-features 'nix-command' eval --impure --raw --expr 'builtins.currentSystem')".dev
